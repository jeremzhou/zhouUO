...
//var cluster_module = angular.module('cluster', ['app.service', 'apollo.directive', 'app.util', 'toastr', 'angular-loading-bar' , 'valdr']);
//node
var node_module = angular.module('node', ['apollo.directive','app.service', 'toastr', 'app.util', 'angular-loading-bar', 'valdr']);
//server
var server_module = angular.module('server', ['apollo.directive','app.service', 'toastr', 'app.util', 'angular-loading-bar', 'valdr']);
//application应用表
var applicationmeta_module = angular.module('applicationMeta', ['apollo.directive','app.service', 'toastr', 'app.util', 'angular-loading-bar', 'valdr']);
