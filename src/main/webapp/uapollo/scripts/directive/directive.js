...
directive_module.directive('apollonav',
                           function ($compile, $window, toastr, AppUtil, AppService, EnvService, UserService, CommonService) {
                               return {
                                   restrict: 'E',
                                   templateUrl: '/uapollo/views/common/nav.html',
                                   transclude: true,
                                   replace: true,
...
*/
                                       scope.sourceApps = [];
                                       scope.copyedApps = [{"appId":"1","name":"11"},{"appId":"2","name":"22"}];
                                      ...
                                      /* function select(app) {
                                       ...
                                       UserService.load_users().then(function (result) {
                                           scope.userName = result.login;
                                       }, function (result) {
...
directive_module.directive('apolloclusterselector', function ($compile, $window, AppService, AppUtil, toastr) {
    return {
        restrict: 'E',
        templateUrl: '/uapollo/views/component/env-selector.html',
        transclude: true,
        replace: true,
        scope: {
            appId: '=apolloAppId',
...
directive_module.directive('apolloconfirmdialog', function ($compile, $window, $sce) {
    return {
        restrict: 'E',
        templateUrl: '/uapollo/views/component/confirm-dialog.html',
        transclude: true,
        replace: true,
        scope: {
...
directive_module.directive('apolloentrance', function ($compile, $window) {
    return {
        restrict: 'E',
        templateUrl: '/uapollo/views/component/entrance.html',
        transclude: true,
        replace: true,
        scope: {
            imgSrc: '=apolloImgSrc',
...
directive_module.directive('apollouserselector', function ($compile, $window) {
    return {
        restrict: 'E',
        templateUrl: '/uapollo/views/component/user-selector.html',
        transclude: true,
        replace: true,
        scope: {
            id: '=apolloId',
...
directive_module.directive('apollomultipleuserselector', function ($compile, $window) {
    return {
        restrict: 'E',
        templateUrl: '/uapollo/views/component/multiple-user-selector.html',
        transclude: true,
        replace: true,
        scope: {
            id: '=apolloId'
