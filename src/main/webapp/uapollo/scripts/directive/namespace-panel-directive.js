...
function directive($window, toastr) {
    return {
        restrict: 'E',
           ...
           /* function editRuleItem(branch, ruleItem) {
            ...
            /*function goToSyncPage(namespace) {
                ...
                $window.location.href =
                    "uapollo/config/sync.html?#/appid=" + scope.appId + "&env="
            ...
            /*function goToParentAppConfigPage(namespace) {
                $window.location.href = "/uapollo/config.html?#/appid=" + namespace.parentAppId;
